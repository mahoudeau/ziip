...
import { MAKER, REPO_URL, SITE_URL } from '../lib/links';

export function Footer() {
  return (
    <footer class="border-t border-border mt-8">
      <div class="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted">
        <a
          href={SITE_URL}
          target="_blank"
